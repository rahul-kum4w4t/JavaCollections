 ...
 * as base for implementation undefined capacity to store values
 * <p>
 ...
 * Time Complexity ------------ 1. Insertion: Omega(1), Theta(log(n)), O(n) 2.
 * Deletion: Omega(1), Theta(log(n)), O(n) 3. Searching: Omega(1),
 * Theta(log(n)), O(n)
 *
...
public class BinarySearchTree<T extends Comparable<T>> extends BinaryTree<T> {
	...
	public BinarySearchTree(boolean inverse) {
	 ...
	 * 
	 * @param node node to be replaced by its parent
	...
	public String getSortingOrder() {
		return orderMul == -1 ? "REVERSE" : "NORMAL";
	}
	 ...
	 * @param grandDir Direction of grand child node (defaults to child node
	 *                 direction if not present)
	 * @param greatDir Direction of great grand child node (defaults to grand child
	 *                 node direction if not present)
